...
class Navbar extends React.Component {
  render() {
    return (
      <div>
        <button type="button" onClick={this.context.changeLanguageEnglish}>
          English
        </button>
        <button type="button" onClick={this.context.changeLanguageFrench}>
          French
        </button>
      </div>
    );
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <h2>
        {languages[languageContext.language].your_role}
        {isAdmin
          ? languages[languageContext.language].admin
          : languages[languageContext.language].user}
      </h2>
